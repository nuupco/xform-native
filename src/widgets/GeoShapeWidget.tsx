...
export function GeoShapeWidget({ ref, store, appearance: _appearance }: GeoShapeWidgetProps) {
        ...
        <View style={styles.modalContent}>
          <View style={styles.mapContainer}>
            ...
            >
              ...
              />
              {shapeGeoJSON && (
                <MapLibre.ShapeSource id="shape" shape={shapeGeoJSON}>
                  <MapLibre.FillLayer
                    id="fill"
                    style={{ fillColor: 'rgba(0,150,136,0.3)', fillOutlineColor: '#009688' }}
                  />
