...
export function androidRippleColor(t: Theme = defaultTheme): string {
...
export function PressableButton({
  ...
  return (
    <Pressable
      ...
      android_ripple={{ color: androidRippleColor(t) }}
      style={({ pressed }) =>
    ...
    >
      <Text style={resolveContentStyle(variant, tone, disabled, t)}>
        {label}
      </Text>
    </Pressable>
  );
