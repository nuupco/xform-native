 ...
 */
const availabilityRegistry = new Map<DataType, () => boolean>([
  ...
  ['binary', () => tryRequire('@nuup/xform-native-binary')],
 ...
 */
export function isWidgetAvailable(dataType: DataType): boolean {
