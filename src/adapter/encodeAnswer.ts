 ...
 */
export function toRawString(dataType: DataType, primitive: unknown): string | null {
  ...
  if (typeof primitive === 'object' && primitive !== null) {
    const geo = primitive as { lat?: unknown; lon?: unknown; alt?: unknown; acc?: unknown };
 ...
 */
export function encodeAnswer(dataType: DataType, primitive: unknown): AnswerValue | null {
