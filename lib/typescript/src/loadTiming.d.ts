 ...
 */
export type FormLoadPhase = 'parseForm' | 'resolveExternalInstances' | 'createFormSession' | 'total';
 ...
 */
export declare function createPhaseTimer(listener: PhaseTimingListener, clock?: PhaseClock): PhaseTimer;
//# sourceMappingURL=loadTiming.d.ts.map