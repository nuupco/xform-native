...
import type { AdaptedEvent, NodeRef, PathSegment } from '../adapter/FormAdapter.js';
import type { AdvanceBlock } from './validation.js';
/**
 ...
 */
export declare const INJECT_VALUES_APPEARANCE = "inject-values";
/**
 ...
 * at every call site.
 */
export declare function renderSlot<C extends {
    defaultElement: ReactNode;
}>(slot: ((ctx: C) => ReactNode) | undefined, ctx: C): ReactNode;
