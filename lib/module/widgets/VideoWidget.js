...
import { VideoIcon } from "./primitives/Icon.js";
...
export function VideoWidget({
  ...
  const player = av?.useVideoPlayer?.(storedUri ? {
    uri: storedUri
  } : null);
  ...
  const blockingGate = isPermissionBlockingState(cameraGate.status) ? cameraGate : isPermissionBlockingState(micGate.status) ? micGate : null;
  const blockingGateKind = isPermissionBlockingState(cameraGate.status) ? 'camera' : isPermissionBlockingState(micGate.status) ? 'mic' : null;
  ...
  if (!readonly && blockingGate && blockingGateKind) {
    const copy = blockingGateKind === 'camera' ? getCameraNoticeCopy(blockingGate.status) : getMicNoticeCopy(blockingGate.status);
    return /*#__PURE__*/_jsx(MediaCaptureCard, {
      ...
      preview: /*#__PURE__*/_jsx(PermissionNotice, {
        ...
        onPrimary: blockingGate.status === 'blocked' ? blockingGate.openSettings : blockingGate.requestPermission,
        dismissLabel: blockingGate.status === 'blocked' ? undefined : 'Ahora no',
        onDismiss: blockingGate.status === 'blocked' ? undefined : blockingGate.dismissRationale
      })
    });
  }
  if (isPlaying && storedUri && VideoView && player) {
    return /*#__PURE__*/_jsx(MediaCaptureCard, {
      ...
      title: "No video recorded",
      disabled: readonly,
      preview: /*#__PURE__*/_jsx(View, {
        style: styles.preview,
        children: /*#__PURE__*/_jsx(VideoView, {
          player: player,
          style: styles.preview,
          contentFit: "contain",
          testID: "video-player"
  ...
  if (storedUri) {
    return /*#__PURE__*/_jsx(MediaCaptureCard, {
      ...
      title: "No video recorded",
      disabled: readonly,
      preview: /*#__PURE__*/_jsx(VideoIcon, {}),
      actions: [{
        label: 'Play',
        onPress: handlePlay,
