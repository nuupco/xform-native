...
import { SelectionRow } from "./primitives/SelectionRow.js";
import { SearchIcon } from "./primitives/Icon.js";
import { BottomSheet } from "./primitives/BottomSheet.js";
import { AppModal } from "./primitives/Modal.js";
import { GeoMapChrome } from "./primitives/GeoMapChrome.js";
...
function parseImageMapShapes(markup) {
...
function parseColumnsN(appearance) {
...
export function SelectOneWidget({
  ...
  const [imageMapMarkup, setImageMapMarkup] = useState(null);
  ...
  const handleSelectFromMap = useCallback(value => {
  ...
  const filtered = useMemo(() => {
    ...
    return choices.filter(c => (c.label ?? c.value).toLowerCase().includes(q) || c.value.toLowerCase().includes(q));
  }, [choices, query]);
    ...
    return /*#__PURE__*/_jsxs(View, {
      ...
      children: [/*#__PURE__*/_jsx(Pressable, {
        ...
        children: /*#__PURE__*/_jsx(Text, {
          ...
          children: stripOdkMarkdown(selected?.label ?? selected?.value ?? 'Select…')
        })
      }), /*#__PURE__*/_jsx(BottomSheet, {
        visible: sheetOpen,
        onClose: () => setSheetOpen(false),
        testID: "select-one-sheet",
        children: choices.map((choice, index) => /*#__PURE__*/_jsx(SelectionRow, {
          testID: `select-one-option-${choice.value}`,
          control: "radio",
          selected: choice.value === currentValue,
          label: choice.label ?? choice.value,
          onPress: () => handleSelect(choice.value)
        }, `${choice.value}__${index}`))
      })]
    });
  }
  if (variant === 'autocomplete') {
    ...
    return /*#__PURE__*/_jsxs(View, {
      ...
      children: [/*#__PURE__*/_jsx(Pressable, {
        ...
        }), filtered.map((choice, index) => /*#__PURE__*/_jsx(SelectionRow, {
          testID: `select-one-option-${choice.value}`,
          control: "radio",
          selected: choice.value === currentValue,
          label: choice.label ?? choice.value,
  ...
  if (variant === 'columns') {
    return /*#__PURE__*/_jsx(View, {
      ...
      children: /*#__PURE__*/_jsx(View, {
        ...
        style: styles.columnsWrap,
        children: choices.map((item, index) => /*#__PURE__*/_jsx(View, {
          style: styles.columnsCell,
          children: /*#__PURE__*/_jsx(SelectionRow, {
  ...
  if (variant === 'label') {
    ...
    return /*#__PURE__*/_jsx(View, {
      style: styles.container,
      children: /*#__PURE__*/_jsx(View, {
        testID: "select-one-label-container",
        style: styles.labelRow,
        children: choices.map((choice, index) => /*#__PURE__*/_jsx(MarkdownText, {
  ...
  if (variant === 'map') {
    ...
    const plottable = choices.map(choice => ({
      choice,
      point: parseGeometry(choice.geometry)
    ...
    if (geo && plottable.length > 0) {
      ...
      const mapCenter = [firstPoint.lon, firstPoint.lat];
      return /*#__PURE__*/_jsxs(View, {
        style: styles.container,
        children: [/*#__PURE__*/_jsx(Pressable, {
          ...
          children: /*#__PURE__*/_jsx(View, {
            ...
            children: /*#__PURE__*/_jsx(GeoMapChrome, {
              children: /*#__PURE__*/_jsxs(MapLibre.Map, {
                style: styles.map,
                mapStyle: OSM_STYLE,
                testID: "select-one-map",
                children: [/*#__PURE__*/_jsx(MapLibre.Camera, {
                ...
                }), geo.SATELLITE_TILE_URI_TEMPLATE && /*#__PURE__*/_jsx(MapLibre.RasterSource, {
                  id: "esri-offline",
                  ...
                  children: /*#__PURE__*/_jsxs(Pressable, {
                    ...
                    onPress: () => handleSelectFromMap(choice.value),
                    children: [/*#__PURE__*/_jsx(View, {
                      style: [styles.mapPin, choice.value === currentValue && styles.mapPinSelected]
                    }), /*#__PURE__*/_jsx(Text, {
                      style: styles.mapPinLabel,
  ...
  if (variant === 'image-map' && imageMapMarkup) {
    ...
    if (svg) {
      const {
        viewBox,
        shapes
      } = parseImageMapShapes(imageMapMarkup);
      const matched = shapes.map(shape => ({
        shape,
        choice: choices.find(c => c.value.toLowerCase() === shape.id.toLowerCase())
      })).filter(m => m.choice !== undefined);
      if (matched.length > 0) {
        return /*#__PURE__*/_jsx(View, {
          style: styles.container,
