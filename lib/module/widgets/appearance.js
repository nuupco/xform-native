 ...
 */
export function resolveVariant(dataType, controlType, appearance) {
  // controlType:range overrides dataType lookup
  const bucket = controlType === 'range' ? APPEARANCE_TABLE['controlType:range'] : APPEARANCE_TABLE[dataType];
