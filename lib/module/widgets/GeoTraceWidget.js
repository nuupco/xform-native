...
export function GeoTraceWidget({
  nodeRef,
  store,
  ...
  const lineGeoJSON = vertices.length >= 2 ? {
    type: 'Feature',
    geometry: {
      type: 'LineString',
  ...
  if (readonly) {
    return /*#__PURE__*/_jsx(View, {
      ...
      testID: "geo-trace-readonly",
      children: /*#__PURE__*/_jsx(Text, {
        style: styles.label,
        children: vertices.length > 0 ? `${vertices.length} vertices` : 'No trace set'
      })
    });
  }
  return /*#__PURE__*/_jsxs(View, {
    style: styles.container,
    testID: "geo-trace-widget",
    children: [/*#__PURE__*/_jsx(Text, {
      style: styles.label,
      children: vertices.length > 0 ? `${vertices.length} vertices` : 'Draw trace'
      ...
      children: /*#__PURE__*/_jsxs(View, {
        ...
        children: [/*#__PURE__*/_jsxs(GeoMapChrome, {
          children: [/*#__PURE__*/_jsxs(MapLibre.Map, {
            ...
            }), lineGeoJSON && /*#__PURE__*/_jsx(MapLibre.GeoJSONSource, {
              id: "trace",
              data: lineGeoJSON,
              children: /*#__PURE__*/_jsx(MapLibre.Layer, {
                id: "trace-line-layer",
            ...
            testID: "geo-trace-prewarm-status"
          })]
...
//# sourceMappingURL=GeoTraceWidget.js.map