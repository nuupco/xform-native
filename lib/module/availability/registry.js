...
['geopoint', () => tryRequire('@nuup/xform-native-geo')], ['geoshape', () => tryRequire('@nuup/xform-native-geo')], ['geotrace', () => tryRequire('@nuup/xform-native-geo')],
...
['binary', opts => {
  ...
  return tryRequire('expo-image-picker') || tryRequire('expo-av') || tryRequire('react-native-svg') || tryRequire('expo-document-picker');
}]]);
